  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex whitespace-nowrap animate-marquee text-goldBrand font-noto font-regular tracking-wider text-base sm:text-xl group-hover:text-goldBrand/50 transition-colors duration-300">
          {Array(12)
