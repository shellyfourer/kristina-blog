    ...
    >
      ...
      >
        <nav aria-label="Primary" className="flex flex-col items-center gap-6">
          ...
          <Link href="/about" className="btn-menu text-sm md:text-lg">
            ABOUT
          </Link>
          <Link href="/blog" className="btn-menu text-sm md:text-lg">
            BLOG
          </Link>
          <Link href="/contact" className="btn-menu text-sm md:text-lg">
            CONTACT
          </Link>
        </nav>
        ...
        <div className="">
          ...
          <Link
            href="https://kristinafourer.substack.com/"
            className="btn-menu text-xs md:text-sm"
            target="_blank"
            rel="noopener noreferrer"
          >
