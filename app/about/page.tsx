                ...
                <div className="max-w-6xl mx-auto flex flex-col items-center text-center gap-8 lg:flex-row lg:items-center lg:gap-16">
                    ...
                    <div className="lg:w-1/2 space-y-6 text-center lg:text-center">
                        ...
                        <p className="text-base sm:text-lg md:text-lg lg:text-lg leading-relaxed">
                            ...
                            My structure disappeared, my joy took an unpaid sabbatical, and I realised I needed
                            to rebuild literally everything — my mind, my body, my routines, my peace, and
                            my personality (she left the chat).
                        </p>
                    </div>
            ...
            <section className="bg-beige text-greenBrand font-noto px-6 py-12 lg:py-20">
                <div className="max-w-6xl mx-auto flex flex-col items-center text-center gap-8 lg:flex-row-reverse lg:items-center lg:gap-16">
                    ...
                    <div className="lg:w-1/2 space-y-6 text-center lg:text-center">
                        ...
                        <p className="text-base sm:text-lg md:text-lg lg:text-lg leading-relaxed">
                            my softer, structured, slightly chaotic-but-still-intentional approach
                            to getting your life together without burning out or running away to live in the woods.
                        </p>

                        <div className="w-16 h-[1px] bg-goldBrand mx-auto"></div>

                        <p className="text-base sm:text-lg md:text-lg lg:text-lg leading-relaxed">
                            Here, I share the fitness habits I’m rebuilding, the hormone-supportive nutrition
                            I’m learning, and the mental health work keeping me semi-stable while juggling
                            corporate life and healing.
                        </p>
                    </div>
            ...
            <section className="bg-beige text-greenBrand font-noto px-6 py-12 lg:py-20">
                <div className="max-w-6xl mx-auto flex flex-col items-center text-center gap-8 lg:flex-row lg:items-center lg:gap-16">
                    ...
                    <div className="lg:w-1/2 space-y-6 text-center lg:text-center">
                        ...
                        <p className="text-base sm:text-lg md:text-lg lg:text-lg leading-relaxed">
                            If you’re exhausted from restarting, trying to feel like yourself again, or simply here
                            for the entertainment value of watching someone rebuild with discipline, therapy, and
                            elite-level sarcasm… welcome. You’re in the right place.  And honestly, if my journey
                            helps even one person feel less lost, less behind, or less like they’re
                        ...
                        <p className="text-base sm:text-lg md:text-lg lg:text-lg leading-relaxed">
                            Around here, motivation only shows up once a month (like my rent bill), so we follow the plan — not the mood.
                        </p>
