  ...
  return (
    <main className="bg-beige text-greenBrand font-noto min-h-screen px-6 py-20">
      ...
      <section className="max-w-3xl mx-auto text-center space-y-4">
        <h2 className="text-3xl sm:text-4xl font-medium tracking-wide">Get in Touch</h2>
      ...
      >
        ...
        <div className="flex flex-col space-y-2">
          <label htmlFor="name" className="text-sm font-medium tracking-wide text-greenBrand/80">
            Name
          </label>
          <input
            type="text"
        ...
        {/* EMAIL */}
        <div className="flex flex-col space-y-2">
          <label htmlFor="email" className="text-sm font-medium tracking-wide text-greenBrand/80">
            Email
          </label>
          <input
            type="email"
        ...
        {/* MESSAGE */}
        <div className="flex flex-col space-y-2">
          <label htmlFor="message" className="text-sm font-medium tracking-wide text-greenBrand/80">
            Message
          </label>
          <textarea
            id="message"
        ...
        {/* BUTTON */}
        <button type="submit" className="btn-brand w-full text-center mt-4">
          SEND MESSAGE
        </button>
      </form>
    </main>
